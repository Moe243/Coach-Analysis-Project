...
| 4for4 2020 play-caller table | URL retained in assignment citations/content checks | Explicit preseason offensive play-caller designations | 31 non-Houston teams in 2020 | Contemporaneous established analysis used only where official weekly evidence is not yet available | Compact designations and evidence terms only | Provisional/medium; does not verify weekly continuity or in-season changes |
