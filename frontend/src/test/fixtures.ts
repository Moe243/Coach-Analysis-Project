...
export const qbSeason: QbSeason = {
  ...
  interceptions: 12,
  sacks: 20,
  yards_per_attempt: 6.83,
  adjusted_net_yards_per_attempt: 6.58,
  passing_touchdown_rate: 0.06,
  ...
  pae_eligibility_status: "eligible",
  pae_reliability: "high",
  pae_model_version: "expected-test",
  team_metric_version: "team-season-statistics-v1",
  team_games: 17,
  team_wins: 11,
  team_losses: 6,
  team_ties: 0,
  team_win_percentage: 0.647,
  team_points_allowed: 330,
  team_points_per_game: 24.76,
  team_total_offensive_yards: 6100,
  team_passing_yards: 4300,
  team_rushing_yards: 1800,
  team_offensive_touchdowns: 48,
  team_turnovers: 18,
  team_sacks_allowed: 28,
  team_offensive_epa_per_play: 0.08,
  team_passing_epa_per_dropback: 0.14,
  team_offensive_success_rate: 0.47,
  team_points_per_game_rank: 8,
  team_offensive_epa_per_play_rank: 7,
  team_passing_epa_per_dropback_rank: 6,
  ...
  coaching_completeness: [
    {
      ...
      citation_count: 1,
      has_in_season_change: false,
      has_interim: false,
      has_shared_duty: false,
      has_unclear_interval: true,
      evidence_version: "c11b-bbf7d43d0e4c4c05",
      source_urls: ["https://example.com/no-role"],
      evidence_intervals: [
        {
          evidence_type: "verified_no_designated_role",
          evidence_key: "2024-DEN-offensive_coordinator-no-role-01-18",
          coach_id: null,
          start_week: 1,
          end_week: 18,
          interval_basis: "season_designation",
